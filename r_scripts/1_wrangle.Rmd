---
title: "Triple difference real wrangling"
...
```{r}
df_merged <- read_rds(here("data_based/data/cleaned_data", "df_merged.rds"))
```
...
# Save resulting DF
```{r}
write_rds(df_strip, here("data_based/data/cleaned_data", "df_strip.rds"))
```
